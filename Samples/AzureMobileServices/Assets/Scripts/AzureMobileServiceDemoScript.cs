...
public class AzureMobileServiceDemoScript : MonoBehaviour
{
    ...
    public void OnFacebookAuthButtonClicked()
    {
        ...
        AzureMobileServices.AuthenticateWithServiceProvider(MobileServiceAuthenticationProvider.Facebook, (user) =>
        {
    ...
    public void OnInsertButtonClicked()
    {
        ...
        AzureMobileServices.Insert<TodoItem>(item1, () =>
        {
            // print something
    ...
    public void OnUpdateButtonClicked()
    {
        ...
        AzureMobileServices.Update<TodoItem>(item1, () =>
        {
            // print something
    ...
    public void OnDeleteButtonClicked()
    {
        ...
        AzureMobileServices.Delete<TodoItem>(item1, () =>
        {
            // print something
    ...
    public void OnLookupButtonClicked()
    {
        ...
        AzureMobileServices.Lookup<TodoItem>(id, (foundItem) =>
        {
            // print something
    ...
    public void OnWhereButtonClicked()
    {
        ...
        TodoItem item1 = new TodoItem { Complete = false, Text = "Todo Updated", Id = "5a34a00d8ef34630b6fe19e0e2c31b8b" };
        AzureMobileServices.Where<TodoItem>(item => item.Text.Contains("Updated"), (items) =>
        {
            // print something
